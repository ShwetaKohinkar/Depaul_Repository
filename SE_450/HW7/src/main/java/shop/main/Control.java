...
class Control {
    ...
    private IUIMenu[] _menus;
    private int _state;

    private IUIForm _getVideoForm;
    ...
    Control(Inventory inventory, UI ui) {
        ...
        UIBuilder f = UIFactory.builderUI();
    ...
    private void addSTART(int stateNum) {
        UIBuilder m = UIFactory.builderUI();
        ...
        m.add("Print top ten all time rentals in order",
                new
                        ...
                        UIMenuAction() {
                            public void run() {
                                // TODO
                                _ui.displayMessage(_inventory.printTenRentals());
